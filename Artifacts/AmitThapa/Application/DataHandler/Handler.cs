...
namespace DataHandler
{
    public class Handler
    {
        ...
        private DataTable CreateStudentTable()
        {
            ...
            DataColumn dataColumn = new DataColumn("Id Number", typeof(int));
            ...
            dt.PrimaryKey = new DataColumn[] { dt.Columns["Id Number"] };
            return dt;
        }
        ...
        private DataTable CreateCourseTable()
        {
            ...
            dt.PrimaryKey = new DataColumn[] { dt.Columns["IdNumber"] };
            return dt;
        }
